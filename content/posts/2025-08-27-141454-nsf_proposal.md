...
## Networking Technology and Systems (NeTS) {#networking-technology-and-systems--nets}
...
## Toward Programmable NICs as Multi-Tenant Cloud Resources {#toward-programmable-nics-as-multi-tenant-cloud-resources}

<https://www.nsf.gov/awardsearch/show-award?AWD_ID=2443203>


## Learning Network Dynamics from Data (predict critical performance metrics like latency and packet loss) {#learning-network-dynamics-from-data--predict-critical-performance-metrics-like-latency-and-packet-loss}

<https://www.nsf.gov/awardsearch/show-award?AWD_ID=2504569>


## Black-box Optimization of White-box Networks: Online Learning for Autonomous Resource Management in NextG Wireless Networks {#black-box-optimization-of-white-box-networks-online-learning-for-autonomous-resource-management-in-nextg-wireless-networks}

<https://www.nsf.gov/awardsearch/show-award?AWD_ID=2312835>


## Causal Reasoning for Data-Driven Networking {#causal-reasoning-for-data-driven-networking}
