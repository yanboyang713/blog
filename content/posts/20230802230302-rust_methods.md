...
Beyond variants on self, there are also [special wrapper types](https://doc.rust-lang.org/reference/special-types-and-traits.html) allowed to be receiver types, such as [Box]({{< relref "20230802021335-rust_box.md" >}})&lt;Self&gt;.
