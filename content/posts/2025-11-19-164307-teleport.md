...
Then copy the one-time **invite** URL that tctl prints to the terminal (it looks like <https://<proxy>:3080/web/invite/%3Ctoken%3E>). Open that link in a browser to finish creating the user.
