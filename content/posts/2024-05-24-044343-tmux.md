...
1.  Install tmux: Use the package manager to install tmux.
...
1.  Verify Installation: After installation, you can verify that tmux is installed by checking its version.
