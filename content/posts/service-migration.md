...
#### TODO [Retrieval Augmented Generation (RAG)]({{< relref "2023-12-06-164642-retrieval_augmented_generation_rag.md" >}}) {#retrieval-augmented-generation--rag----dot-dot-references-2023-12-06-164642-retrieval-augmented-generation-rag-dot-md}

[Org-roam MCP Server]({{< relref "2025-09-19-190143-org_roam_mcp_server.md" >}})


#### TODO The Multi-Agent Roster &amp; Roles {#the-multi-agent-roster-and-roles}
