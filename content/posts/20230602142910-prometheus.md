...
<a id="figure--fig:Pro-Arch"></a>

{{< figure src="https://prometheus.io/assets/architecture.png" caption="<span class=\"figure-number\">Figure 1: </span>Prometheus Architecture" width="150px" >}}
