...
[AWS]({{< relref "20230314144515-aws.md" >}}) Batch enables developers, scientists, and engineers to run hundreds of thousands of batch computing jobs easily and efficiently on AWS.
...
AWS Batch efficiently and dynamically provisions and scales [AWS EC2]({{< relref "2023-10-28-183931-aws_compute.md" >}}) and Spot Instances based on the requirements of your jobs. AWS Batch provides default job queues and compute environment definitions that enable you to get started quickly.
