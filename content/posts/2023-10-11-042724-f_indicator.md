...
It is a generalized version of the $F$-measure. The \\(F\_\beta\\) score allows you to weigh the importance of precision \\(P\\) versus recall \\(R\\) by introducing the \\(\beta\\) parameter:
