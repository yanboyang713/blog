...
-   [Regression]({{< relref "20230516184350-regression.md" >}}): This method identifies the relation among two dependent attributes so that if we have one attribute, it can be used to predict the other attribute.
