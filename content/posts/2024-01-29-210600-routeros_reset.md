...
## Using Reset Button {#using-reset-button}

RouterBOARD devices are fitted with a reset button which has several functions:


### Loading the backup RouterBOOT loader {#loading-the-backup-routerboot-loader}
...
### Resetting the RouterOS configuration {#resetting-the-routeros-configuration}
...
### Starting the RouterBOARD in Netinstall mode {#starting-the-routerboard-in-netinstall-mode}
