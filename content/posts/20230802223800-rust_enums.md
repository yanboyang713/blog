...
-   This might be a good time to compare Structs and Enums:
    -   In both, you can have a simple version without fields (unit [Struct]({{< relref "20230802215540-rust_structs.md" >}})) or one with different types of fields (variant payloads).
