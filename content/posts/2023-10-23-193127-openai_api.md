...
First of all, create a new project. Go to the [Projects page](https://platform.openai.com/settings/proj_default/general) and create a new project from the vertical menu on the left.
...
Go to the [API Keys](https://platform.openai.com/api-keys) page and click on the button Create new secret key.
