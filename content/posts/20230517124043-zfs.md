...
## Identify disks by stable names {#identify-disks-by-stable-names}
...
Use the _dev/disk/by-id_... paths in all ZFS commands (more stable than /dev/sdX).
...
## Wipe any existing signatures (destructive) {#wipe-any-existing-signatures--destructive}
...
## Create a striped ZFS pool (RAID0) {#create-a-striped-zfs-pool--raid0}
...
## Add it to [Proxmox VE (PVE)]({{< relref "20230228043925-proxmox_ve.md" >}}) as VM storage {#add-it-to-proxmox-ve--pve----20230228043925-proxmox-ve-dot-md--as-vm-storage}
...
## Using RAM to make ZFS faster {#using-ram-to-make-zfs-faster}

<https://pve.proxmox.com/wiki/ZFS_on_Linux#sysadmin_zfs_limit_memory_usage>


### ARC (RAM read cache) — the big lever {#arc--ram-read-cache--the-big-lever}
