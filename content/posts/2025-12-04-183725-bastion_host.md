...
## JumpServer vs Teleport {#jumpserver-vs-teleport}

Both [JumpServer]({{< relref "2023-12-10-185134-jumpserver.md" >}}) and [Teleport]({{< relref "2025-11-19-164307-teleport.md" >}}) are modern Privileged Access Management (PAM) and bastion host solutions, but they have different architectural philosophies and target audiences.
...
| **Protocol Support**    | SSH, RDP, VNC, Telnet, K8s, DB             | SSH, RDP, [Kubernetes]({{< relref "20230105185343-kubernetes.md" >}}), DB, App (HTTP), Windows |
