...
Prophet is a forecasting procedure developed by Facebook's Core Data Science team. It is invented for [Time Series]({{< relref "20230404184340-time_series.md" >}}) data based on an additive model that can fit non-linear trends with yearly seasonality, weekly seasonality, and even daily seasonality, together with holiday effects.
