...
AWS Glue runs the ETL jobs on a fully managed, scale-out Apache [Spark]({{< relref "2023-10-13-002405-spark.md" >}}) environment to load your data into its destination.
