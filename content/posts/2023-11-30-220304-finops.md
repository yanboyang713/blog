...
FinOps is a cloud financial discipline that unify finance with [DevOps]({{< relref "20230616191259-devops.md" >}}), which is the combination of development and operations teams, creating new cross-discipline teams. This practice objective is helping companies in managing better their cloud costs, and making financial team cooperate with developers.
...
-   [kube-green]({{< relref "2023-11-30-221105-kube_green.md" >}})
-   [kubectl-cost]({{< relref "2023-11-30-221258-kubectl_cost.md" >}})
-   [cloud custodian]({{< relref "2023-11-30-221434-cloud_custodian.md" >}})
-   [apptio cloudability]({{< relref "2023-11-30-221553-apptio_cloudability.md" >}})
