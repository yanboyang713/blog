---
title: "org-reveal"
tags: ["slides", "org", "reveal", "emacs"]
draft: false
---

## Introduction {#introduction}

In this article, I will talk about ****How to using [Emacs]({{< relref "20230107214049-emacs.md" >}}) with org-reveal to make a slideshows**** base on [org mode]({{< relref "20230303075139-org_mode.md" >}}). This article will based on [Jake](https://www.youtube.com/watch?v=avtiR0AUVlo)'s video in ****YouTube****.
...
## More Customize {#more-customize} {#more-customize-more-customize}
...
1.  Doing not every element into a sigle slide
