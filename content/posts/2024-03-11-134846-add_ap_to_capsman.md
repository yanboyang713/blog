...
make sure AP [Enabling CAPs mode]({{< relref "2024-01-29-210600-routeros_reset.md#enabling-caps-mode" >}}).
...
## Attach AP to CAPsMAN controller {#attach-ap-to-capsman-controller}
