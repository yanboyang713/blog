...
Electronic schematic and [printed circuit board (PCB)]({{< relref "2024-05-30-114919-printed_circuit_board_pcb.md" >}}) design tools
...
## Assign Footprints {#assign-footprints}
